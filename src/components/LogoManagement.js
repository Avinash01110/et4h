...
const LogoManagement = () => {
  ...
  return (
    <div className="flex justify-center items-center h-auto">
      <div className="container mx-auto p-4 bg-black rounded-lg shadow-lg overflow-y-scroll h-full py-10">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl text-white font-bold text-center w-full">Logo Management</h1>
        </div>

        <div className="mb-6 text-center">
          <button
            className="bg-black hover:bg-black border border-solid border-white/20 text-white text-md font-semibold menu-item 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 py-10 overflow-y-scroll bg-black h-auto ">
          {logos.map((logo) => (
            <div
              key={logo._id}
            ...
            >
              ...
              <a href={logo.link} target="_blank" rel="noopener noreferrer" className="mb-4 text-white hover:underline break-all">
                {logo.link}
              </a>
              <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-6 rounded-lg shadow-xl w-96 max-w-full">
              ...
              <div className="flex justify-end space-x-2">
                ...
                <button
                  className="bg-gray-300 hover:bg-gray-400 text-white px-4 py-2 rounded-lg transition duration-300"
